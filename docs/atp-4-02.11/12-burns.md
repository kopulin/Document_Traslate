...
> **譯註**：本譯稿以繁體中文為主體，專有名詞首次出現時附上英文原文與縮寫。圖片已抽出並嵌入（200 dpi PNG）；圖 12-4「九則律」的百分比數值已完整譯出於標註下方。
...
<figure>
  <img src="/images/atp-4-02.11/fig-12-04.png" alt="圖 12-4．燒傷面積百分比「九則律」" />
